...
ModuleTitleScreen::Init() {
    ...
    btnNewGame = new Button(
        imgNormal, imgMouseOver, NULL, mainmenu_x, mainmenu_y, 0, 700);
    ...
    btnLoadGame = new Button(
        imgNormal, imgMouseOver, NULL, mainmenu_x, mainmenu_y + 60, 0, 701);
    ...
    btnSettings = new Button(
        imgNormal, imgMouseOver, NULL, mainmenu_x, mainmenu_y + 120, 0, 702);
    ...
    btnCredits = new Button(
        imgNormal, imgMouseOver, NULL, mainmenu_x, mainmenu_y + 180, 0, 703);
    ...
    btnQuit = new Button(
        imgNormal, imgMouseOver, NULL, mainmenu_x, mainmenu_y + 240, 0, 704);
...
ModuleTitleScreen::Draw() {
    ...
    al_draw_scaled_bitmap(m_background,
                          0,
                          0,
