...
class ModulePlanetSurface : public Module {
  ...
  public:
    ...
    void CreatePSObyItemID(std::string scriptName,
                           int itemid,
                           int itemx = -1,
                           int itemy = -1);
    ...
    bool fabMolten();
    bool fabAcidic();
    void fabPlanetSurfaceObjects(std::string scriptName,
...
int L_PostMessage(lua_State *luaVM);  // Lua Example: L_PostMessage(0, 0, 255,
                                      // "You lick it...it doesn't taste good")
int L_LoadPortrait(lua_State *luaVM); // Lua Example: L_LoadPortrait("mineral",
                                      // "data/mineralPortrait01.bmp")
int L_ShowPortrait(lua_State *luaVM); // Lua Example: L_ShowPortrait("mineral")
int L_AddItemtoCargo(
...
int L_GetCounters(lua_State *luaVM);   // Lua Example: counter1, counter2,
                                       // counter3 = L_GetCounters()
int L_GetThresholds(lua_State *luaVM); // Lua Example: threshold1, threshold2,
                                       // threshold3 = L_GetThresholds()
int L_IsPlayerMoving(
...
int L_GetMinimapSize(lua_State *luaVM); // Lua Example: size =
                                        // L_GetMinimapSize()
...
int L_SetCounters(lua_State *luaVM);    // Lua Example: L_SetCounters(counter1,
                                        // counter2, counter3)
int
