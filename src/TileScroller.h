...
class TileSet {
  public:
    ...
    ///
    /// \param[in] bitmap
    ///     Pointer to the ALLEGRO_BITMAP containing the image.
    /// \param[in] width
    ...
    int get_tile_width() const { return m_width; }

    /// Retrieve height
    ///
    /// \return The height of tiles in the tile set.
    int get_tile_height() const { return m_height; }
...
class TileScroller : public Module {
  public:
    ...
    /// \return void
    void set_tile(int x, int y, short value) {
