...
ModuleTopGUI::Draw() {
    ...
    al_draw_bitmap_region(img_hull_gauge,
                          0,
                          0,
                          al_get_bitmap_width(img_hull_gauge) * hull_percent,
                          al_get_bitmap_height(img_hull_gauge),
                          ggx + 89,
                          ggy + 15,
                          0);
    al_draw_bitmap_region(img_armor_gauge,
                          0,
                          0,
                          al_get_bitmap_width(img_armor_gauge) * armor_percent,
                          al_get_bitmap_height(img_armor_gauge),
                          ggx + 273,
                          ggy + 15,
                          0);
    al_draw_bitmap_region(img_shield_gauge,
                          0,
                          0,
                          al_get_bitmap_width(img_shield_gauge) *
                              shield_percent,
                          al_get_bitmap_height(img_shield_gauge),
                          ggx + 464,
                          ggy + 15,
                          0);
    al_draw_bitmap_region(img_fuel_gauge,
                          0,
                          0,
                          al_get_bitmap_width(img_fuel_gauge) * fuel_percent,
                          al_get_bitmap_height(img_fuel_gauge),
                          ggx + 630,
                          ggy + 14,
                          0);
}
