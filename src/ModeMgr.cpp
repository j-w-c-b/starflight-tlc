...
void
ModeMgr::AddMode(const string &modeName,
                 Module *rootModule,
...
void
ModeMgr::BroadcastEvent(Event *event) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
...
void
ModeMgr::OnKeyPress(int keyCode) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnKeyPressed(int keyCode) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnKeyReleased(int keyCode) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMouseMove(int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMouseClick(int button, int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMousePressed(int button, int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMouseReleased(int button, int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMouseWheelUp(int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
...
void
ModeMgr::OnMouseWheelDown(int x, int y) {
    ALLEGRO_ASSERT(m_activeRootModule || !g_game->IsRunning());
    if (m_activeRootModule == NULL)
        return;
