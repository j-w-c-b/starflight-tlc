...
if (plot_stage == 1) then -- initial plot state
	...
	questions[50000] = {
		action="branch",
		choices = {
			{ text="What type of freak are you?",  goto_next=51000 },
			{ text="Home world location", goto_next=52000 },
...
elseif (plot_stage == 2) or (plot_stage == 3) or (plot_stage == 4) then -- other plot states
	...
	questions[51000] = {
		action="jump", goto_next=51001, ftest= 6, -- very aggravating
		player="[AUTO_REPEAT]",
...
elseif (plot_stage == 4) then -- ancients plot state
	...
	questions[21001] = {
		action="branch",
		choices = {
			{ text="The Tafel",  goto_next=21000 },
			{ text="The Minex",  goto_next=22000 },
			{ text="The Bar-zhon",  goto_next=23000 },
	...
	questions[21002] = {
		action="branch",
		choices = {
			{ text="The Spemin",  goto_next=24000 },
			{ text="The Thrynn and Elowan",  goto_next=25000 },
			{ text="The Thrynn and Elowan conflict",  goto_next=26000 },
			{ text="<Back>", goto_next=1 }
		}
	}
...
if (plot_stage == 4) then
	...
	questions[11001] = {
		action="branch",
		choices = {
			{ text="Nyssian history",  goto_next=11000 },
			{ text="Nyssian biology", goto_next=12000 },
			{ text="Your agenda", goto_next=13000 },
			{ text="Your technology", goto_next=14000 },
			{ text="<Back>", goto_next=1 }
		}
	}
	questions[11000] = {
	...
	questions[13000] = {
		action="jump", goto_next=13101, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[13101] = {
		action="branch",
		choices = {
			{ title="You are a mystic?", text="So you consider yourself some type of mystic?", goto_next=13110 },
			{ text="<Back>", goto_next=11001 }
		}
	}
	questions[13110] = {
		action="jump", goto_next=13112, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
		alien={"Yes." }
	}
	questions[13112] = {
		action="branch",
		choices = {
			{ title="Mystics are self-deluded.", text="Mystics are self-deluded individuals who do not accept the objective reality of physical laws in a physical universe.", goto_next=13113 },
			{ title="Reality is harsh.", text="Reality is harsh.  Mystics die when others make demands on them.", goto_next=13114 },
			{ text="<Back>", goto_next=11001 }
		}
	}
	questions[13113] = {
		action="jump", goto_next=997, ftest= 6, -- very aggregating
		player="[AUTO_REPEAT]",
	...
	questions[13114] = {
		action="jump", goto_next=13115, ftest= 6, -- very aggravating
		player="[AUTO_REPEAT]",
		alien={"<Silence>" }
	}
	questions[13115] = {
	...
	questions[31001] = {
		action="branch",
		choices = {
			{ text="The Great War",  goto_next=31100 },
			{ text="The Golden Ages",  goto_next=31200 },
			{ text="<More>",  goto_next=31002 },
			{ text="<Back>", goto_next=1 }
		}
	}
	questions[31002] = {
		...
		choices = {
			...
			{ text="Yourselves",  goto_next=31400 },
			{ text="The Empire",  goto_next=31500 },
			{ text="<Back>", goto_next=1 }
		}
	}
	...
	questions[40000] = {
		action="jump", goto_next=31301,  ftest= 1,
		player="[AUTO_REPEAT]",
	...
	questions[31400] = {
		action="jump", goto_next=31401, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
		playerFragment="about yourselves",
	...
	questions[31101] = {
		action="branch",
		choices = {
			{ text="Downfall of the civilizations?",  goto_next=31110 },
			{ text="Start of the war", goto_next=31120 },
			{ text="What civilizations collapsed?", goto_next=31130 },
			{ title="Why is this relevant?", text="What does any of that have to do with today?",goto_next=31140 },
	...
	questions[31301] = {
		action="branch",
		choices = {
			{ text="Origins of the ancients",  goto_next=31310 },
			{ text="Where did they go?",  goto_next=31320 },
			{ text="<More>",  goto_next=31302 },
			{ text="<Back>", goto_next=31002 }
		}
	}
	questions[31302] = {
		action="branch",
		choices = {
			{ text="Perfection",  goto_next=31330 },
			{ text="Endurium",  goto_next=31340 },
			{ text="Personality of the ancients",  goto_next=31350 },
			{ text="<Back>", goto_next=31002 }
		}
	}
	questions[31310] = {
		action="jump", goto_next=31301,
		player="[AUTO_REPEAT]",
	...
	questions[31320] = {
		action="jump", goto_next=31301, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[31330] = {
		action="jump", goto_next=31302, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[31401] = {
		action="branch",
		choices = {
			{ text="Nyssian people",  goto_next=31410 },
			{ text="Crew on board",  goto_next=31420 },
			{ text="Trade",  goto_next=31430 },
			{ text="Type of government",  goto_next=31440 },
			{ text="<Back>", goto_next=31002 }
		}
	}
	questions[31410] = {
		action="jump", goto_next=31401, ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
	...
	questions[31501] = {
		action="branch",
		choices = {
			{ title="Survived?  Past tense?", text="Survived?  Past tense?  Do you know that all other humans are extinct?", goto_next=31510 },
			{ title="Human alliance",  text="You mentioned that my race formed an alliance?", goto_next=31520 },
			{ text="Where was this empire?",  goto_next=31530 },
			{ text="<More>",  goto_next=31502 },
			{ text="<Back>", goto_next=31002 }
		}
	}
	questions[31502] = {
		action="branch",
		choices = {
			{ text="Empire humanity",  goto_next=31540 },
			{ text="The future",  goto_next=31550 },
			{ text="Do you have any advice?",  goto_next=31560 },
			{ text="<Back>", goto_next=31002 }
		}
	}
	questions[31510] = {
	...
	questions[31550] = {
		action="jump", goto_next=31502, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
...
if (plot_stage == 2) then -- virus plot state
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ text="Infection", goto_next=61000 },
			{ text="Dark Age", goto_next=62000 },
			{ text="Curing this infection", goto_next=63000 },
			{ text="Specifics", goto_next=64000 },
	...
	questions[61001] = {
		action="branch",
		choices = {
			{ text="Rapid transmission of the virus", goto_next=61100 },
			{ text="The virus causes death?", goto_next=61200 },
			{ text="Progress towards a cure", goto_next=61300 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[61100] = {
		action="jump", goto_next=61001, ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
...
elseif (plot_stage == 3) then -- war plot state
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ text="Why the Minex are going to war", goto_next=61000 },
			{ text="Stopping the Minex", goto_next=62000 },
			{ text="How great wars been resolved previously", goto_next=63000 },
			{ text="<Back>", goto_next=50000 }
		}
	}
	questions[61000] = {
	...
	questions[63000] = {
		action="jump", goto_next=63001, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[61001] = {
		action="branch",
		choices = {
			{ text="Infected attacking the Minex", goto_next=61100 },
			{ text="Balanced conflagration", goto_next=61200 },
			{ text="Vissah", goto_next=61300 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[61100] = {
	...
	questions[62001] = {
		action="branch",
		choices = {
			{ text="Stopping the the Minex War", goto_next=62100 },
			{ text="Convincing the Minex to stop fighting", goto_next=62200 },
			{ text="Talking to the Minex", goto_next=62300 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[62100] = {
	...
	questions[62200] = {
		action="jump", goto_next=62201, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[63002] = {
		action="branch",
		choices = {
			{ text="A deserted city", goto_next=63100 },
			{ text="The Minex", goto_next=63200 },
			{ text="Ourselves?  You mean humans?", goto_next=63300 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[63100] = {
	...
	questions[63300] = {
		action="jump", goto_next=63002, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
...
elseif (plot_stage == 4) then -- ancients plot state
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ title="<Reveal Minex Secret>", text="The Minex revealed that the Ancients may have a base located at Lir IV.", goto_next=61000 },
			{ text="Nano-machines?", goto_next=62000 },
			{ text="Galactic Situation", goto_next=63000 },
			{ text="Ancients might be causing the problems", goto_next=64000 },
			{ text="<Back>", goto_next=6 }
		}
	}
	questions[61000] = {
		action="jump", goto_next=61001, ftest= 2, -- insightful jjh
		--player="[AUTO_REPEAT]",
	...
	questions[64000] = {
		action="jump", goto_next=64001, ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
	...
	questions[62001] = {
		action="branch",
		choices = {
			{ text="Races that possess the technology", goto_next=62100 },
			{ text="Races with advanced knowledge", goto_next=62200 },
			{ text="Alternative sources of advanced technology", goto_next=62300 },
			{ text="Supernatural source", goto_next=62400 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[62100] = {
	...
	questions[63001] = {
		action="branch",
		choices = {
			{ text="Source of information", goto_next=63100 },
			{ text="Technology and ruins", goto_next=63200 },
			{ text="Telepathy", goto_next=63300 },
			{ text="Races most affected", goto_next=63400 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[63100] = {
		action="jump", goto_next=63101,
		player="[AUTO_REPEAT]",
	...
	questions[63301] = {
		action="branch",
		choices = {
			{ text="The precursor races", goto_next=63310 },
			{ text="The Uhlek", goto_next=63320 },
			{ text="<Back>", goto_next=63001 }
		}
	}
	questions[63310] = {
		action="jump", goto_next=63301,
	...
	questions[64001] = {
		action="branch",
		choices = {
			{ text="The Ancients abilities", goto_next=64100 },
			{ text="The Enemy of the Ancients", goto_next=64200 },
			{ text="How the enemy was defeated", goto_next=64300 },
			{ text="<Back>", goto_next=60001 }
		}
	}
	questions[64100] = {
	...
	questions[64200] = {
		action="jump", goto_next=64001, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[91001] = {
		action="branch",
		choices = {
			{ text="Yes, we have that artifact and are willing to trade.",  goto_next=91100 },
			{ text="I could not let it go for less than 12 endurium.",  goto_next=91200 },
			{ text="No, we don't have that artifact.",  goto_next=91300 },
			{ text="I'm not willing to part with it right now.", goto_next=1 }
		}
	}
	questions[91100] = {
...
--]]
	...
	questions[92001] = {
		action="branch",
		choices = {
			{ title="Thrynn reaper", text="what a Thrynn reaper is",  goto_next=92100 },
			{ title="Bribe", text="What about in exchange for 20 endurium crystals?",  goto_next=92200 },
			{ text="You will turn over your data crystals, Now! ",  goto_next=92300 },
			{ text="Forget this.  I'm not going to bother.", goto_next=92400 }
		}
	}
	questions[92100] = {
		action="jump", goto_next=1,
...
--]]
	...
	questions[77001] = {
		action="branch",
		choices = {
			{ title="Pressing Matters?", text="What pressing matters are you referring to?",  goto_next=77100 },
			{ title="Bribe", text="Perhaps five units of fuel may assist in your pressing matters.",  goto_next=77200 },
			{ title="Threaten", text="This is urgent! We demand that you tell us any information you may have concerning these criminals!",  goto_next=77300 },
			{ text="Nevermind, let me ask you about something else.", goto_next=1 }
		}
	}
	questions[77100] = {
		action="jump", goto_next=77001, ftest= 1,
		player="[AUTO_REPEAT]",
	...
	questions[77205] = {
		action="jump", goto_next=997,  ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[78001] = {
		action="branch",
		choices = {
			{ title="Yes", text="Yes, transmitting hypercube scanning data to you now.", goto_next=78002 },
			{ text="No",  goto_next=1 },
		}
	}
	questions[78002] = {
...
--]]
	...
	questions[86001] = {
		action="branch",
		choices = {
			{ text="25 radioactives", goto_next=86100 },
			{ text="120 endurium", goto_next=86200 },
			{ title="Barter", text="We don't quite have that many resources available. What about in exchange for 60 endurium?", goto_next=86300 },
			{ title="Request Further Details", text="Could you describe exactly what the Na'tash generator does?", goto_next=86400 },
			{ text="<New subject>", goto_next=1 }
		}
	}
	questions[86100] = {
		action="jump", goto_next=1, ftest= 1, -- artifact267 Na'tash generator
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[86501] = {
		action="branch",
		choices = {
			{ text="25 radioactives", goto_next=86600 },
			{ text="120 endurium", goto_next=86700 },
			{ title="Why the Na'tash?", text="Why did you offer us the Na'tash first?", goto_next=86800 },
			{ title="Does it work?", text="Does this Krang device actually work to penetrate shields?", goto_next=86900 },
			{ text="<New subject>", goto_next=1 }
		}
	}
	questions[86600] = {
		action="jump", goto_next=1, ftest= 1, -- artifact268 The Krang
		player="[AUTO_REPEAT]",
		playerFragment="the device for 25 radioactives",  fragmentTable=preQuestion.desire,
		alien={"Indeed we are ready to receive your transport." }
	}
...
--]]
	...
	questions[83000] = {
		action="jump", goto_next=1,  ftest= 1, -- artifact339 Nyssian response
...
--]]
	...
	questions[86000] = {
		action="jump", goto_next=86001, ftest= 1, -- remove and replace artifact362 Bar-zhon Analyzed Organic Monstrosity
