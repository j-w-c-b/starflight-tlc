...
if (plot_stage == 1) or (plot_stage == 3) then
	...
	questions[30000] = {
		action="jump", goto_next=30001, ftest= 1,
		player="[AUTO_REPEAT]",
...
if (plot_stage == 1) then -- initial plot state
	...
	questions[50000] = {
		action="branch",
		choices = {
			{ title="Stop attacking the Elowan!", text="We demand that your race cease attacking the Elowan!",  goto_next=51000 },
--			{ text="Where is your home world?", goto_next=52000 },
			{ text="Are you looking for any technologies or artifacts?", goto_next=53000 },
...
elseif (plot_stage == 3) then -- war plot state
	...
	questions[50000] = {
		...
		choices = {
			{ title="Stop attacking the Elowan !", text="We demand that your race cease attacking the Elowan!",  goto_next=51000 },
--			{ text="Where is your home world?", goto_next=52000 },
			{ text="Technologies or artifacts", goto_next=53000 },
...
if (plot_stage == 1) or (plot_stage == 3) then
	...
	questions[53000] = {
		action="jump", goto_next=53001, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[53001] = {
		action="branch",
		choices = {
			{ text="Elowan Shield Capacitor",  goto_next=53100 },
			{ text="The Spiral Lens", goto_next=53200 },
			{ text="Bar-zhon Data Core", goto_next=53300 },
			{ text="Coalition Afterburner Unit", goto_next=53400 },
...
if (plot_stage == 1) then -- initial plot state
	...
	questions[51000] = {
		action="jump", goto_next=51001, ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
	...
	questions[51001] = {
		action="branch",
		choices = {
			{ title="Demand with force", text="We will attack you if you do not cease.",  goto_next=51100 },
			{ title="Appeal to morality", text="Your attacks upon them are wrong!", goto_next=51200 },
			{ title="Appeal to reason", text="The Elowan are no threat to you.", goto_next=51300 },
			{ title="Offer to help", text="We will do anything you ask to bring about peace.", goto_next=51400 },
			{ text="<Back>", goto_next=50000 }
		}
	}
	questions[51100] = {
	...
	questions[51200] = {
		action="jump", goto_next=50001, ftest= 3, -- aggravating
		player="[AUTO_REPEAT]",
	...
	questions[51400] = {
		action="jump", goto_next=50001, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
...
elseif (plot_stage == 3) then -- war plot state
	...
	questions[51001] = {
		action="branch",
		choices = {
			{ text="Convince the Elowan",  goto_next=51100 },
			{ text="War against the Minex", goto_next=51200 },
			{ text="Why they have attacked", goto_next=51300 },
			{ text="Minex tactics", goto_next=51400 },
			{ text="<Back>", goto_next=50000 }
		}
	}
	questions[51100] = {
	...
	questions[51400] = {
		action="jump", goto_next=51001, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ text="Source of the virus", goto_next=61000 },
			{ text="Artifacts that resemble the virus technology", goto_next=62000 },
			{ text="Minex responsible?", goto_next=63000 },
			{ text="Elowan responsible?", goto_next=64000 },
			{ text="<Back>", goto_next=50000 }
		}
	}
	questions[61000] = {
...
if (plot_stage == 1) or (plot_stage == 3) then
	questions[11001] = {
		action="branch",
		choices = {
			{ text="Your society",  goto_next=11000 },
			{ text="Oviparous?", goto_next=12000 },
			{ text="<Back>", goto_next=1 }
		}
	}
	questions[11000] = {
	...
	questions[11101] = {
		action="branch",
		choices = {
			{ text="Merciless?",  goto_next=11110 },
			{ text="The poor & the outcasts",  goto_next=11120 },
			{ text="Government",  goto_next=11130 },
			{ text="Such inhumanity is hard to imagine.",  goto_next=11140 },
	...
	questions[11140] = {
		action="jump", goto_next=11141, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
	...
	questions[11141] = {
		action="branch",
		choices = {
			{ text="Empire humanity?",  goto_next=11142 },
			{ text="News from Earth?",  goto_next=11143 },
			{ text="Our ancestors trace our history to Noah 3.",  goto_next=11144 },
			{ title="You are allies of humanity?", text="So you were close allies with humanity in the past?", goto_next=11145 },
			{ text="<Back>", goto_next=11101 }
		}
	}
	questions[11142] = {
		action="jump", goto_next=11141,
		player="[AUTO_REPEAT]",
...
if (plot_stage == 1) then -- initial plot state
	...
	questions[21001] = {
		action="branch",
		choices = {
			{ text="The Elowan",  goto_next=21000 },
			{ text="Other alien races",  goto_next=22000 },
			{ text="Why can't you just all get along?",  goto_next=23000 },
			{ text="<Back>", goto_next=1 }
		}
	}
	questions[23000] = {
	...
	questions[23001] = {
		action="jump", goto_next=999,  ftest= 3, -- aggravating, attack the player
		player="[AUTO_REPEAT]",
		playerFragment="...",
		alien={"(Roar!)" }
	}
elseif (plot_stage == 3) then -- war plot state
	...
	questions[21001] = {
		...
		choices = {
			{ text="The Elowan",  goto_next=21000 },
			{ text="Other alien races",  goto_next=22000 },
			{ text="Assist in stopping the Minex",  goto_next=23000 },
			{ text="<Back>", goto_next=1 }
		}
	}
	questions[23000] = {
...
if (plot_stage == 1) or (plot_stage == 3) then
	...
	questions[21101] = {
		action="branch",
		choices = {
			{ title="Intelligent plants", 	text="The Elowan are intelligent plants?", goto_next=21100 },
			{ text="The Elowan are dangerous?",  goto_next=21200 },
			{ text="Elowan warships",  goto_next=21300 },
			{ text="Why fight them",  goto_next=21400 },
	...
	questions[22101] = {
		action="branch",
		choices = {
			{ text="The Minex",  goto_next=22100 },
			{ text="The Bar-Zhon",  goto_next=22200 },
			{ text="The Spemin",  goto_next=22300 },
			{ text="The Tafel",  goto_next=22400 },
			{ text="<Back>", goto_next=21001 }
		}
	}
end
...
elseif (plot_stage == 3) then -- war plot state
	...
	questions[22105] = {
		action="jump", goto_next=22101, ftest= 2, -- insightful
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[92001] = {
		action="branch",
		choices = {
			{ title="Truth", text="The Nyssian want the technology.",  goto_next=92100 },
			{ title="Bribe", text="What about in exchange for 20 endurium?",  goto_next=92200 },
			{ title="Force", text="You will give us a copy of this device now! ",  goto_next=92300 },
...
--		active_quest = active_quest + 1
	...
	questions[92201] = {
		action="branch",
		choices = {
			{ text="Yes, transporting now.",  goto_next=92202 },
			{ text="No.",  goto_next=92203 },
		}
	}
	questions[92202] = {
...
--]]
	...
	questions[96100] = {
		action="jump", goto_next=96101, ftest= 1,
--		artifact10 = 0
--		active_quest = active_quest + 1
...
--]]
	...
	questions[98001] = {
		action="branch",
		choices = {
			{ text="Yes, I agree to 16 endurium.",  goto_next=98100 },
			{ text="No.",  goto_next=98200 },
		}
	}
	questions[98100] = {
--		artifact18 = 0
...
--]]
	...
	questions[78001] = {
		action="branch",
		choices = {
			{ title="Targeting System", text="Sounds good, please transport over the Minex targeting system.", goto_next=78100 },
			{ title="Power Core", text="Sounds good, please transport over the Minex power core.", goto_next=78200 },
			{ title="Beam Mount", text="Sounds good, please transport over the Minex beam mount.", goto_next=78300 },
			{ title="Missile Turret", text="Sounds good, please transport over the Minex missile turret.", goto_next=78400 },
			{ title="Silver Gadget", text="Sounds good, please transport over the Minex silver gadget.", goto_next=78500 },
		}
	}
	questions[78100] = {
...
--]]
	...
	questions[79000] = {
		action="jump", goto_next=1, ftest= 1, -- artifact281 Thrynn Flight Recording
		title="Unrest",
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[81001] = {
		action="branch",
		choices = {
			{ title="Yes", text="Yes, we are ready.", goto_next=81010 },
			{ title="No", text="No, not right now.", goto_next=81020 },
			{ title="Challenge?", text="What challenge do you mean?", goto_next=81030 },
		}
	}
	questions[81010] = {
		action="jump", goto_next=81050,
		player="[AUTO_REPEAT]",
	...
	questions[81051] = {
		action="branch",
		choices = {
			{ title="Bid?", text="What was our bid?", goto_next=81060 },
			{ title="Task", text="What task do you have for us?", goto_next=81070 },
			{ title="Terminate", text="Something urgent has come up, we'll be back later", goto_next=81080 },
		}
	}
	questions[81060] = {
		action="jump", goto_next=81061,
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[81100] = {
		action="jump", goto_next=997, ftest= 1, -- remove artifacts 296-300 Melted Composite
...
--]]
	...
	questions[81200] = {
		action="jump", goto_next=997, ftest= 1, -- remove artifact308 Geometric Crystals
...
--]]
	...
	questions[81300] = {
		action="jump", goto_next=997, ftest= 1, -- remove artifact312-313 engine components and gravity field generator
...
--]]
	...
	questions[81400] = {
		action="jump", goto_next=997, ftest= 1, -- remove artifact324 organic growth
...
--]]
	...
	questions[81500] = {
		action="jump", goto_next=81501, ftest= 1, -- remove artifact327 Cone device
...
--]]
	...
	questions[81600] = {
		action="jump", goto_next=997, ftest= 1, -- remove artifacts329-334 Radioactive Exotic Elements, provide 50 endurium, end the mission
...
--]]
	...
	questions[82001] = {
		action="branch",
		choices = {
			{ title="Install experimental lasers", text="I am ready for you to install the prototype laser turrets.", goto_next=82100 },
			{ title="Remove experimental lasers", text="Please return my original laser turrets.", goto_next=82200 },
			{ title="Install experimental missiles", text="I am ready for you to install the prototype missile launchers.", goto_next=82300 },
			{ title="Remove experimental missiles", text="Please return my original missile launchers.", goto_next=82400 },
			{ title="End Mission", text="I am done with my testing, sending over camera footage now.", goto_next=82500 },
		}
	}
	questions[82100] = {
		action="jump", goto_next=82001,  ftest= 1,
		player="[AUTO_REPEAT]",
...
--]]
	...
	questions[83000] = {
		action="jump", goto_next=1,  ftest= 1, -- artifact337 Thrynn response
...
--]]
	...
	questions[87001] = {
		action="branch",
		choices = {
			{ title="Yes", text="I accept your offer.  Transporting now.",  goto_next=87100 },
			{ text="No thanks",  goto_next=87200 },
		}
	}
	questions[87100] = {
		action="jump", goto_next=1, ftest= 1, -- artifact363 = 0. 50 Quorsitanium, end mission
		player="[AUTO_REPEAT]",
		alien={"Commencing exchange." }
	}
	questions[87200] = {
...
--]]
	...
	questions[401] = {
		action="branch",
		choices = {
			{ text="Yes, I agree.",  goto_next=410 },
			{ text="No.",  goto_next=420 },
		}
	}
	questions[410] = {
...
--		artifact10 = 0
	...
	questions[601] = {
		action="branch",
		choices = {
			{ text="Yes, I agree.",  goto_next=610 },
			{ text="No.",  goto_next=620 },
		}
	}
	questions[610] = {
--		endurium = endurium + 7
--		artifact13 = 0
	...
	questions[701] = {
		action="branch",
		choices = {
			{ text="Yes, I agree.",  goto_next=710 },
			{ text="No.",  goto_next=720 },
		}
	}
	questions[710] = {
...
--		artifact15 = 0
	...
	questions[801] = {
		action="branch",
		choices = {
			{ text="Yes, I agree.",  goto_next=810 },
			{ text="No.",  goto_next=820 },
		}
	}
	questions[810] = {
